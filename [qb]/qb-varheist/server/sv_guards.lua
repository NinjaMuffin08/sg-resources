...
local lootTable = { -- You can always add more, make sure to also add this to the confiscateContraband table
    [1] = {item = 'pistol_ammo', amount = 6},
    [2] = {item = 'rifle_ammo', amount = 6},
    [3] = {item = 'armor', amount = 3},
    [4] = {item = 'bandage', amount = 4},
    [5] = {item = 'water_bottle', amount = 3},
    [6] = {item = 'sandwich', amount = 3},
    [7] = {item = 'ifak', amount = 1},
    [8] = {item = 'var_medkit', amount = 3},
}
