			...
			if modelName == 'JOURNEY' and car then
					...
					if GetPedInVehicleSeat(car, -1) == playerPed then
						...
						if IsControlJustReleased(0, Keys['Y']) and GetLastInputMethod( 0 ) then
							if pos.y >= 3500 then
								if GetClockHours() >= 6 and GetClockHours() <= 23 then
									...
									QBCore.Functions.Notify('Time should be between 06:00 to 23:00 ..', 'error')
								end
							else
			...
			if progress < 98 then
				...
				if progress > 22 and progress < 24 then
					...
					if selection == 0 then
						...
						TriggerEvent('chatMessage', " The propane pipe is leaking, What do you do? Press the number of the option you want to do? ", "warning")
						--ESX.ShowNotification('~o~1. Fix using tape')
						--QBCore.Functions.Notify('N7. Fix using tape', 'success')
						TriggerEvent('chatMessage', " Num7. Fix using tape ", "warning")
						--ESX.ShowNotification('~o~2. Leave it be ')
						--QBCore.Functions.Notify('N8. Leave it be', 'success')
						TriggerEvent('chatMessage', " Num8. Leave it be ", "warning")
						--ESX.ShowNotification('~o~3. Replace it')
						--QBCore.Functions.Notify('N9. Replace it', 'success')
						TriggerEvent('chatMessage', " Num9. Replace it ", "warning")
				...
				if progress > 30 and progress < 32 then
					...
					if selection == 0 then
						...
						TriggerEvent('chatMessage', " You spilled a bottle of acetone on the ground, what do you do? ", "warning")
						--ESX.ShowNotification('~o~1. Open the windows to get rid of the smell')
						--QBCore.Functions.Notify('Num7. Open the windows to get rid of the smell', 'success')
						TriggerEvent('chatMessage', " Num7. Open the windows to get rid of the smell ", "warning")
						--ESX.ShowNotification('~o~2. Leave it be')
						--QBCore.Functions.Notify('Num8. Leave it be', 'success')
						TriggerEvent('chatMessage', " Num8. Leave it be ", "warning")
						--ESX.ShowNotification('~o~3. Put on a mask with airfilter')
						--QBCore.Functions.Notify('Num9. Put on a mask with airfilter', 'success')
						TriggerEvent('chatMessage', " Num9. Put on a mask with airfilter ", "warning")
						--ESX.ShowNotification('~c~Press the number of the option you want to do')
						--QBCore.Functions.Notify('Press the number of the option you want to do..', 'success')
					end
					if selection == 1 then
				...
				if progress > 41 and progress < 43 then
					...
					if selection == 0 then
						...
						TriggerEvent('chatMessage', " You accidentally pour too much acetone, what do you do? ", "warning")
						--ESX.ShowNotification('~o~1. Do nothing')
						--QBCore.Functions.Notify('N7. Do nothing', 'success')
						TriggerEvent('chatMessage', " Num7. Do nothing ", "warning")
						...
						TriggerEvent('chatMessage', " Num8. Try to sucking it out using syringe ", "warning")
						...
						TriggerEvent('chatMessage', " Num9. Add more lithium to balance it out ", "warning")
						--ESX.ShowNotification('~c~Press the number of the option you want to do')
						--QBCore.Functions.Notify('Press the number of the option you want to do', 'success')
					end
					if selection == 1 then
				...
				if progress > 46 and progress < 49 then
					...
					if selection == 0 then
						...
						TriggerEvent('chatMessage', " You found some water coloring, what do you do? ", "warning")
						--QBCore.Functions.Notify('N7. Add it in', 'success')
						TriggerEvent('chatMessage', " Num7. Add it in ", "warning")
					  --	ESX.ShowNotification('~o~2. Put it away')
						--QBCore.Functions.Notify('N8. Put it away', 'success')
						TriggerEvent('chatMessage', " Num8. Put it away ", "warning")
						--ESX.ShowNotification('~o~3. Drink it')
						--QBCore.Functions.Notify('N9. Drink it', 'success')
						TriggerEvent('chatMessage', " Num9. Drink it ", "warning")
						--ESX.ShowNotification('~c~Press the number of the option you want to do')
						--QBCore.Functions.Notify('Press the number of the option you want to do', 'success')
					end
					if selection == 1 then
				...
				if progress > 63 and progress < 65 then
					...
					if selection == 0 then
						--ESX.ShowNotification('~o~The propane pipe is leaking, what do you do?')	
						--QBCore.Functions.Notify('The propane pipe is leaking, What do you do?', 'success')
						TriggerEvent('chatMessage', " The propane pipe is leaking, What do you do? ", "warning")
						--ESX.ShowNotification('~o~1. Fix using tape')
						--QBCore.Functions.Notify('N7. Fix using tape', 'success')
						TriggerEvent('chatMessage', " Num7. Fix using tape ", "warning")
						--ESX.ShowNotification('~o~2. Leave it be ')
				...
				if progress > 71 and progress < 73 then
					...
					if selection == 0 then
						...
						--ESX.ShowNotification('~o~2. Replace the filter')
						--QBCore.Functions.Notify('N8. Replace the filter', 'success')
						TriggerEvent('chatMessage', " Num8. Replace the filter ", "warning")
						--ESX.ShowNotification('~o~3. Clean it using a tooth brush')
						--QBCore.Functions.Notify('N9. Clean it using a tooth brush', 'success')
						TriggerEvent('chatMessage', " Num9. Clean it using a tooth brush ", "warning")
						--ESX.ShowNotification('~c~Press the number of the option you want to do')
				...
				if progress > 82 and progress < 84 then
					...
					if selection == 0 then
						...
						TriggerEvent('chatMessage', " You need to take a shit, what do you do? ", "warning")
				...
				if progress > 88 and progress < 90 then
					...
					if selection == 0 then
						...
						TriggerEvent('chatMessage', " Do you add some glass pieces to the meth so it looks like you have more of it? ", "warning")	
						--ESX.ShowNotification('~o~1. Yes!')
						--QBCore.Functions.Notify('N7. Yes!', 'success')
						TriggerEvent('chatMessage', " Num7. Yes! ", "warning")
						--ESX.ShowNotification('~o~2. No')
						--QBCore.Functions.Notify('N8. No', 'success')
						TriggerEvent('chatMessage', " Num8. No ", "warning")
						...
						TriggerEvent('chatMessage', " Num9. What if I add meth to glass instead ", "warning")
						--ESX.ShowNotification('~c~Press the number of the option you want to do')
						--QBCore.Functions.Notify('Press the number of the option you want to do', 'success')
					end
					if selection == 1 then
				...
				if IsPedInAnyVehicle(playerPed) then
					...
					if pause == false then
						...
						--ESX.ShowNotification('~r~Meth production: ~g~~h~' .. progress .. '%')
						QBCore.Functions.Notify('Chemical production: ' .. progress .. '%', 'success')
					end
				else
					TriggerEvent('qb-methcar:stop')
				end
				...
				pause = true
				started = false
				QBCore.Functions.Notify('Meth chemical Production: ' ..progress.. '%', 'success')
				QBCore.Functions.Notify('Meth chemical Production finished', 'success')
