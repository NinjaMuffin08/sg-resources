...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 250000, bank = 500000, crypto = 70000 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Player.ThirstRate = 9.8 -- Rate at which thirst goes down.
