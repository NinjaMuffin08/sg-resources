...
Config.MinimalDoctors = 0 -- How many players with the ambulance job to prevent the hospital check-in system from being used
...
Config.PainkillerInterval = 20 -- Set the length of time painkillers last (per one)
Config.HealthDamage =  100 -- Minumum damage done to health before checking for injuries
Config.ArmorDamage = 100 -- Minumum damage done to armor before checking for injuries
Config.ForceInjury = 100 -- Maximum amount of damage a player can take before limb damage & effects are forced to occur
Config.AlwaysBleedChance = 1 -- Set the chance out of 100 that if a player is hit with a weapon, that also has a random chance, it will cause bleeding
Config.MessageTimer = 12 -- How long it will take to display limb/bleed message
Config.AIHealTimer = 5 -- How long it will take to be healed after checking in, in seconds
Config.BleedTickRate = 200 -- How much time, in seconds, between bleed ticks
...
Config.BleedTickDamage = 1 -- The base damage that is multiplied by bleed level everytime a bleed tick occurs
...
Config.HeadInjuryTimer = 1 -- How much time, in seconds, do head injury effects chance occur
Config.ArmInjuryTimer = 1 -- How much time, in seconds, do arm injury effects chance occur
Config.LegInjuryTimer = 1 -- How much time, in seconds, do leg injury effects chance occur
Config.HeadInjuryChance = 1 -- The chance, in percent, that head injury side-effects get applied
Config.LegInjuryChance = { -- The chance, in percent, that leg injury side-effects get applied
    Running = 1,
    Walking = 1
}
Config.MajorArmoredBleedChance = 1 -- The chance, in percent, that a player will get a bleed effect when taking heavy damage while wearing armor
...
Config.DamageMinorToMajor = 99 -- How much damage would have to be applied for a minor weapon to be considered a major damage event. Put this at 100 if you want to disable it
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["beds"] = {
        [1] = {coords = vector4(-3271.78, -3763.48, 14.54, 168.12), taken = false, model = 1631638868},
        [2] = {coords = vector4(-3269.08, -3768.47, 14.64, 73.17), taken = false, model = 1631638868},
        [3] = {coords = vector4(-3271.66, -3762.82, 14.54, 353.42), taken = false, model = 2117668672},
        [4] = {coords = vector4(-3277.38, -3773.56, 6.55, 169.49), taken = false, model = 2117668672},
        [5] = {coords = vector4(-3274.34, -3774.35, 6.55, 163.15), taken = false, model = 2117668672},
        [6] = {coords = vector4(-3285.96, -3789.76, 7.11, 74.59), taken = false, model = -1091386327},
        [7] = {coords = vector4(-3286.8, -3793.15, 7.11, 59.09), taken = false, model = -1091386327},
        [8] = {coords = vector4(-3284.39, -3773.61, 7.09, 170.82), taken = false, model = -1091386327},
	--- paleto
