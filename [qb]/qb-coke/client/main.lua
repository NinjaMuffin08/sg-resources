...
Citizen.CreateThread(function()
    while true do
        ...
        local distance = #(PlayerPos - vector3(1093.17, -3194.75, -38.99))
        
        if distance < 6 then
            inRange = true

            if distance < 2 then
                DrawText3Ds(1093.17, -3194.75, -38.99, "[G] Process Coca Leaf")
...
Citizen.CreateThread(function()
    while true do
        ...
        local distance1 = #(PlayerPos - vector3(5210.97, -5141.99, 8.89))
        local distance2 = #(PlayerPos - vector3(5210.62, -5144.11, 8.94))
        local distance3 = #(PlayerPos - vector3(5212.84, -5143.39, 9.02))
        
        if distance1 < 15 then
            inRange = true

     if distance1 < 2 then
                DrawText3Ds(5210.97, -5141.99, 8.89, "[G] Start Picking")
                if IsControlJustPressed(0, 47) then
                    PrepareAnim()
                    PickMinigame()
                end
            ...
            if distance2 < 2 then
                DrawText3Ds(5210.62, -5144.11, 8.94, "[G] Start Picking")
                if IsControlJustPressed(0, 47) then
                    PrepareAnim()
                    PickMinigame()
                end
            ...
            if distance3 < 2 then
                DrawText3Ds(5212.84, -5143.39, 9.02, "[G] Start Picking")
                if IsControlJustPressed(0, 47) then
                    PrepareAnim()
                    PickMinigame()
                end
...
Citizen.CreateThread(function()
    while true do
        ...
        local distance = #(PlayerPos - vector3(1389.12, 3605.33, 38.94))
        
        if distance < 6 then
            inRange = true

            if distance < 2 then
                DrawText3Ds(1389.12, 3605.33, 38.94, "[G] Process Crack")
                if IsControlJustPressed(0, 47) then
