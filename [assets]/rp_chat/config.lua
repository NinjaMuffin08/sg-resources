...
Config.EnableSurvivor = true

Config.SurvivorCommand = 'survivor'

Config.SurvivorIcon = 'fas fa-door-open'

Config.SurvivorMessageTitle = 'Survivor'

Config.SurvivorMessageWithoutCommand = true -- true: sends Survivor message without command (/survivor) | false: doesn't send any message without it being a command
...
Config.AutoMessageTime = 10 -- (in minutes) will send messages every x minutes 

Config.AutoMessages = {
	"Ensure to read the Rules and Policies for SG:RP.",
	"Type /report to send reports to the staff.",
}
