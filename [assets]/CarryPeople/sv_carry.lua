...
if GetResourceState([[pac]]) == [[started]] and exports[tostring[[pac]]]:WasEventCanceled([[cmg2_animations:sync]]) then return end
...
if GetResourceState([[pac]]) == [[started]] and exports[tostring[[pac]]]:WasEventCanceled([[cmg2_animations:stop]]) then return end
