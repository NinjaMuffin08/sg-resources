...
AddEventHandler("tp-advancedzombies:onZombieSync", function()
	...
	SetRelationshipBetweenGroups(RELATIONSHIP_HATE, GetHashKey("zombie"), GetHashKey("PLAYER"))
	SetRelationshipBetweenGroups(RELATIONSHIP_HATE, GetHashKey("PLAYER"), GetHashKey("zombie"))
	SetRelationshipBetweenGroups(RELATIONSHIP_HATE, GetHashKey("zombie"), GetHashKey("zombie"))
...
Citizen.CreateThread(function()
	...
	while true do
		...
		for _, group in ipairs(relationshipTypes) do
			SetRelationshipBetweenGroups(RELATIONSHIP_HATE, GetHashKey(group), GetHashKey('zombie'))
