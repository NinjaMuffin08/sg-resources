...
Citizen.CreateThread(function()
	...
	AddEventHandler("ZombieSync", function()
		while true do
			...
			SetRelationshipBetweenGroups(5, GetHashKey("zombies"), GetHashKey("looters"))
			SetRelationshipBetweenGroups(5, GetHashKey("zombies"), GetHashKey("badanimals"))
			SetRelationshipBetweenGroups(5, GetHashKey("zombies"), GetHashKey("animals"))
			SetRelationshipBetweenGroups(5, GetHashKey("zombies"), GetHashKey("friends"))
			SetRelationshipBetweenGroups(5, GetHashKey("zombies"), GetHashKey("ngf"))
			...
			if #superzombies < maxSuperZombies then
				...
				SetPedRelationshipGroupHash(superzombie, GetHashKey("zombies"))
