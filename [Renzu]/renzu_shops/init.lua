...
shared.FinanceMinimum = 50000 -- minimum amount for financing to be enable
shared.FinanceDownPayment = 5 -- 20%. this is the amount of minimum initial payment
shared.FinanceInterest = 5 -- 10%
shared.FinanceMaxDays = 165
shared.MaxDebt = 450000 -- max amount of total debt from player in able to finance
shared.defaultStock = {
	General = 100, 
	Ammunation = 50,
	VehicleShop = 50,
